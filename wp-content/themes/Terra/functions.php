...
function boc_style() {
    ...
    wp_enqueue_style( 'boc-fonts', "$protocol://fonts.googleapis.com/css?family=Lato:400,600,900|Open+Sans:300italic,400italic,600italic,400,300,600,900|PT+Serif:400,400italic" );
	...
	if(($aqua_main_color)&&($aqua_main_color!="#9DD91F")){
		$inline_css .='	
	    	...
	    	#footer.footer_light .boc_latest_post img:hover { border: 1px solid '.$aqua_main_color.'; background: '.$aqua_main_color.';}
		';
...
function boc_scripts() {
	 ...
	 wp_enqueue_script('jquery.easing', get_template_directory_uri().'/js/libs.min.js');
