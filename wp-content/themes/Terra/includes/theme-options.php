...
*/  
  ...
  $custom_settings = array(
	...
	array(
	  ...
	  'id'          => 'show_search',
	  'type'        => 'select',
	  'desc'        => 'You can choose "No" if you want to hide your Search form in the Header',
	  'choices'     => array(
	    array(
	      'label'       => 'Yes',
	      'value'       => true
...
array(
  ...
  'type'        => 'select',
  'desc'        => 'The container rows will be animated as soon as the user scrolls to half of the container row. Please bear in mind this cool feature makes sense only in Static Pages and only where the Container Row shortcode is used. Enjoy!',
  'choices'     => array(
    array(
      'label'       => 'No',
      'value'       => false
...
array(
	  ...
	  'std'         => 'page_heading_style_minimal',
	  'rows'        => '',
	  'post_type'   => '',
	  'taxonomy'    => '',
	  'class'       => '',
...
array(
  ...
  'std'         => '<a href="http://themeforest.net/user/blueowlcreative/portfolio?ref=blueowlcreative" target="_blank">Terra Theme</a> &copy; 2013 &nbsp; | &nbsp; <a href="http://www.blueowlcreative.com" target="_blank">BlueOwlCreative</a>',
  'rows'        => '',
  'post_type'   => '',
  'taxonomy'    => '',
  'class'       => '',
...
array(
  ...
  'id'          => 'portfolio_style',
  'type'        => 'select',
  'desc'        => 'Choose one of the available presets for displaying your portfolio items',
  'choices'     => array(
    array(
      'label'       => 'Style 1',
      'value'       => 'type1'
