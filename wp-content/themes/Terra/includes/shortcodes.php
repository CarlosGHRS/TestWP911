...
function register_button($buttons) {
   array_push($buttons, "heading","big_heading","button", "checklist","highlight","tooltip","accordion","tabs","big_title","feat_text","testimonials","posts_carousel","portfolio_carousel","slider","counters","counter_circles","clients_section","table","price_table","message","person","icon","border", "youtube","vimeo");    
   return $buttons;
}
...
function shortcode_logo($atts, $content = null) {
	...
	$str= ($img_url ? '<div class="three columns client_info">
			<a href="" class="tooltipsy" original-title="'.($text ? $text : '').'"><img src="'.$img_url.'"></a>
		  </div>': '');
