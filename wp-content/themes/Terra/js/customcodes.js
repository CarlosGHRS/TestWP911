	...
	tinymce.create('tinymce.plugins.clients_section', {  
		init : function(ed, url) {  
			ed.addButton('clients_section', {  
				...
				onclick : function() {
					ed.selection.setContent('[clients_section heading="Partners & Clients" subheading="The jolly bunch we get to work with" text="Cleints Section Description Text"]<p>[logo img_url="" text=""][/logo]</p><p>[logo img_url="" text=""][/logo]</p><p>[logo img_url="" text=""][/logo]</p>[/clients_section]');
				}
			});
		},
		createControl : function(n, cm) {
